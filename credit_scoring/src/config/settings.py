...
DB_CONFIG = {
    ...
    "password": os.getenv("CREDIT_DB_PASSWORD", "Jenifer12"),
    "database": os.getenv("CREDIT_DB_NAME", "credit_system"),
}

GENDER_OPTIONS = ["Male", "Female"]

RELATIONSHIP_OPTIONS = ["New Applicant", "Existing Customer", "Referral", "Other"]
